...
public enum Data {
    LIST_ORGANIZATION(new ArrayList<String>()),
    LIST_TYPE_OF_SUBSCRIPTION(new ArrayList<String>()),
    LIST_ORGANIZATION_ADD(new ArrayList<String>()),
    LIST_TYPE_OF_SUBSCRIPTION_ADD(new ArrayList<String>()),
    DATE_START(new ArrayList<String>()),
    DATE_INF(new ArrayList<String>());

    public static final Logger logger = LogManager.getLogger();
    private Object value;
    private static String fileAddress = System.getenv("APPDATA") + "\\.SP";
